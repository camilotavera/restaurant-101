...
('Omelette Gourmet', 'Omelette relleno de champiñones, queso manchego y hierbas frescas con pan artesanal', 24000, 'Desayuno', 'https://images.unsplash.com/photo-1598683387379-5bc77d0bc4c0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80');

-- Almuerzos
INSERT INTO menus (nombre, descripcion, precio, categoria, imagen) VALUES
('Pasta Carbonara', 'Pasta fresca con salsa cremosa de huevo, queso parmesano, panceta y pimienta negra', 32000, 'Almuerzo', 'https://images.unsplash.com/photo-1588013273468-315fd88ea34c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'),
('Pechuga a la Plancha', 'Pechuga de pollo marinada en hierbas, servida con arroz pilaf y vegetales al vapor', 28000, 'Almuerzo', 'https://images.unsplash.com/photo-1670398564097-0762e1b30b3a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'),
...
('Risotto de Champiñones', 'Risotto cremoso con champinones silvestres, queso parmesano y trufa negra', 38000, 'Cena', 'https://images.unsplash.com/photo-1476124369491-e7addf5db371?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'),
...
('Pasta al Pesto', 'Pasta fresca con pesto casero de albahaca, piñones y queso parmesano', 30000, 'Cena', 'https://images.unsplash.com/photo-1567608285969-48e4bbe0d399?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'),
